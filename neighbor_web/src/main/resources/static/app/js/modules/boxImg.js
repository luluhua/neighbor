...
$(document).ready(function () {
    $(".content-wrapper .imgdow").click(function () {

        $("body").css({overflow: "hidden"});
        //给body添加弹出层的html
        $("body").append("<div  class=\"mask-layer\">" +
            "   <div  class=\"mask-layer-black\"></div>" +
            "   <div style='width: 80%;' class=\"mask-layer-container\">" +
            "       <div class=\"mask-layer-imgbox auto-img-center\"></div>" +
            "       <div class=\"mask-layer-container-operate\">" +
            "           <button class=\"mask-shangyizhang btn-default-styles\">上一张</button>" +
            ...
            "           <button class=\"mask-xiayizhang btn-default-styles\">下一张</button>" +
            "       </div>" +
            "   </div>" +
            "</div>"
        );
        ...
        num = img_index
        $(".mask-xiayizhang").click(function () {
            if (num < len) {
                num = num + 1;
                $(".mask-layer-imgbox img").prop("src", arrPic[num]);
            } else {
                layer.msg("已经是最后一张了")
            }
        });
        $(".mask-shangyizhang").click(function () {
            if (num != 1) {
                num = num - 1;
                $(".mask-layer-imgbox img").prop("src", arrPic[num]);
            } else {
        ...
        function showImg() {
            $(".mask-layer-imgbox").append("<p><!--startprint--><img id='delta' src=\"\" alt=\"\"><!--endprint--></p>");
