...
public class DingDingUtil {
     ...
     * @throws Exception
     */
    public static boolean DeleteToken() throws Exception {
     ...
     * @throws Exception
     */
    public static OapiUserGetDeptMemberResponse getDeptUserIdList(String deptId) throws Exception {
        try {
            String accessToken = getToken();
     ...
     * @throws Exception
     */
    public static OapiDepartmentListResponse getDepartmentList() throws Exception {
        try {
            String accessToken = getToken();
            DingTalkClient client = new DefaultDingTalkClient("https://oapi.dingtalk.com/department/list");
            OapiDepartmentListRequest request = new OapiDepartmentListRequest();
//            request.setId("123");
     ...
     * @throws Exception
     */
    public static OapiAttendanceListRecordResponse getAttendanceList(List userids) throws Exception {
        try {
            String accessToken = getToken();
            DingTalkClient client = new DefaultDingTalkClient("https://oapi.dingtalk.com/attendance/listRecord");
            OapiAttendanceListRecordRequest request = new OapiAttendanceListRecordRequest();
            request.setCheckDateFrom("2020-04-29 08:00:00");
            request.setCheckDateTo("2020-04-29 23:59:59");
     ...
     * @throws Exception
     */
    public static List getEquipmentList() throws Exception {
        try {
            String accessToken = getToken();
            ...
            OapiSmartdeviceDeviceQuerylistRequest.PageQueryVo obj1 = new OapiSmartdeviceDeviceQuerylistRequest.PageQueryVo();
            obj1.setPk("yourproductkey");
            obj1.setCursor(0L);
            obj1.setSize(20L);
            req.setPageQueryVo(obj1);
            OapiSmartdeviceDeviceQuerylistResponse rsp = client.execute(req, accessToken);
