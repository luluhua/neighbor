...
<script type="text/javascript" src="js/member_return.js"></script>
...
<div class="member_cent">
	<div class="left">
		...
		<ul class="menu_ul">
			...
			<li><a href="member_return.html" class="menu_a">退货/退款</a></li>
		</ul>
	</div>
		...
		<div class="common_border">
			...
			<div class="orderA_div">
				...
				<ul class="orderA_ul">
					...
					<li class="date_liB">待收货</li>

					<li class="date_liC">
						<a href="refunds.html" class="date_a">退货/退款</a>

						<a href="">确定收货</a>

						<a href="Check_logistics.html">查看物流</a>
					</li>
				</ul>
			</div>
