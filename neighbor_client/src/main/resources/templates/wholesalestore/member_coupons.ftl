...
<script type="text/javascript" src="js/member_coupons.js"></script>
...
<div class="member_cent">
	<div class="left">
		...
		<ul class="menu_ul">
			...
			<li><a href="member_coupons.html" class="menu_a">我的优惠券</a></li>
	...
	<div class="right">
		<div class="common_border">
			...
			<!--没有产品时的页面-->
			<div class="order_none_coupons">
				<p>您暂时没有优惠券，<a href="index.html">去领取　！＞＞</a></p>
			</div>
