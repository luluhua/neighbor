...
<script type="text/javascript" src="../store/js/ajaxfileupload.js"></script>
<script type="text/javascript" src="js/numberQueries.js"></script>
<script type="text/javascript" src="js/member_store.js"></script>
...
<div class="member_cent">
	<div class="left">
		...
		<ul class="menu_ul">
			...
			<li><a href="member_store.html" class="menu_a">认证信息</a></li>
	...
	<div class="right">
		<div class="common_border">
			...
			<ol class="password_ol store_ol">						

				<li>
					<p>经销商名称:</p>
					<sub id="dealerName" style="line-height: 34px; font-size: 16px;"></sub>					
				</li>

				<li>
					<p>经销商地址:</p>
					<sub id="dealerAddress" style="line-height: 34px; font-size: 16px;"></sub>					
				</li>

				<li>
					<p>经销商电话:</p>
					<sub id="dealerPhone" style="line-height: 34px; font-size: 16px;"></sub>					
				</li>

               <li>
					<p>认证时间:</p>
					<sub id="certificateDate" style="line-height: 34px; font-size: 16px;"></sub>					
			  </li>

				<li>
					<p>邀请人:</p>
					<sub id="inviter" style="line-height: 34px; font-size: 16px;"></sub>					
				</li>
