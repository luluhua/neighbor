...
<script type="text/javascript" src="js/productparticulars.js"></script>
	...
	<div class="pr_infor">
		...
		<div class="infor_fr">
			...
			<div class="share jiathis_style">
				...
				<style type="text/css">
				.jiathis_style a {width: 43px; height: 42px; margin: 0px 5px;}
				.jiathis_style .jiathis_button_tsina span{background: url(images/icon_17.png) no-repeat top center; width: 43px;height: 42px!important; padding-left: 0px!important}
				.jiathis_style .jiathis_button_weixin span{background: url(images/icon_18.png) no-repeat top center; width: 43px;height: 42px!important; padding-left: 0px!important}
			</style>
