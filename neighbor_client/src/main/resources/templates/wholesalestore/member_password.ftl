...
<script type="text/javascript" src="js/member_password.js"></script>
...
<div class="head">
	...
	<div class="search">
		...
		<input type="text" id="SearchGoods" onkeypress="if (event.keyCode == 13) Skip();" placeholder="Search" class="text"/>
		<input type="button" value="搜索" class="button" onclick="Skip()" title="搜索">
	</div>
...
<div class="member_cent">
	<div class="left">
		...
		<ul class="menu_ul">
			...
			<li><a href="member_password.html" class="menu_a">修改密码</a></li>
		...
		<div class="common_border">
			...
			<ol class="password_ol">
				<li>
					...
					<p>原来密码：</p>
					<input type="password" id="originalPassword" value="" placeholder="输入原来密码">
				</li>

				<li>
					<span id="new_Password"></span>
					<p>新改密码：</p>
					<input type="password" id="newPassword" value="" placeholder="由字母和数字组成，不少于6位字符">
				</li>

				<li>
					<span id="confir_Password"></span>
					<p>确认密码：</p>
					<input type="password" id="confirPassword" value="" placeholder="再次输入密码">
				</li>
