...
<script type="text/javascript" src="../store/js/Upload_the_picture.js"></script>
<script type="text/javascript" src="js/numberQueries.js"></script>
<script type="text/javascript" src="js/member_picture.js"></script>
...
<div class="member_cent">
	<div class="left">
		...
		<ul class="menu_ul">
			...
			<li><a href="member_store.html">店家认证</a></li>
	...
	<div class="right">
		<dl>
			<dd>
				<a href="javascript:void"><img id="ports1" src="" title="修改头像"></a>
