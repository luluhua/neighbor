package com.citysmart.ucenter.common.ihuyi;//接口类型：互亿无线触发短信接口，支持发送验证码短信、订单通知短信等。
...
//        TSmsConfig smsConfig = smsConfigService.selectOne(ew);
        ...
        NameValuePair[] data = {//提交短信
                new NameValuePair("account", "cf_18172302295"),
                new NameValuePair("password", "acfb2048aa7bf0a18ca488d834f0829c"),
