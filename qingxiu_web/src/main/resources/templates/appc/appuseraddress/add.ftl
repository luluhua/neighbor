...
<form class="form-horizontal layui-form layui-form-pane" method="post"
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="addressName" name="addressName"
                       class="form-control" placeholder="请输入地址名称" />
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="contactPhone" name="contactPhone"
                        class="form-control" placeholder="请输入联系人电话"
                       lay-verify="required"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="userId" class="col-sm-2 control-label">用户<span class="xing_red">*</span></label>
            <div class="col-sm-10">
