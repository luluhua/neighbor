...
<@body>
<form class="form-horizontal layui-form layui-form-pane" method="post" action="/appc/tAppStartupPageManage/doEdit">
    <input type="hidden" name="id" value="${(entity.id)!}">
    <div class="box-body">
        <div class="form-group">
            <label for="aName" class="col-sm-2 control-label">版本名称<span class="xing_red"> *</span></label>
            <div class="col-sm-10">
                <input type="text" id="aName" name="aName" value="${(entity.aName)!}" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="aCode" name="aCode" class="form-control input-select-200"
                       value="${(entity.aCode)!}" placeholder="请输入版本号" lay-verify="required"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <@dictTag method="getDictListByType" type="app_type" >
                    <#list getDictListByType as m>
                                <input type="radio" name="aType"<#if "${(m.value)!}"=="${(entity.aType)!}">checked</#if>
                                       class="minimal" value="${(m.value)!}" lay-ignore>
                        ${(m.label)!}
                            &nbsp;
                    </#list>
                </@dictTag>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="hidden" id="aStartupPageUrl" name="aStartupPageUrl" value="${(entity.aStartupPageUrl)!}"
                       lay-verify="required">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <ul class="uiisar aStartupPageUrl_url">
                    ...
                    <#if entity.aStartupPageUrl ?? && entity.aStartupPageUrl!="" >
                        <li>
                            <span class="layui-icon  layui-icon-close" name="aStartupPageUrl"
                                  test="${(entity.aStartupPageUrl)!''}">&#x1006;</span>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <@dictTag method="getDictListByType" type="is_yes_no" >
                    <#list getDictListByType as m>
                                <input type="radio" name="aStatus"
                                       <#if "${(m.value)!}"=="${(entity.aStatus)!}">checked</#if> class="minimal"
