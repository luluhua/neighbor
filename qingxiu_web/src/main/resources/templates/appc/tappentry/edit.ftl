...
<@body>
    <form class="form-horizontal layui-form layui-form-pane" method="post" action="/appc/tAppEntry/doEdit">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select name="pid" class="form-control select2 input-select-200" lay-verify="required" lay-ignore>
                        <#list appEntryGroups as m>
                            <option value="${(m.id)!}" ${(m.id==entity.pid)?string('selected','')}>${(m.titile)!}</option>
                        </#list>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="code" disabled value="${(entity.code)!'--'}" class="form-control input-title-700" placeholder="请输入编码"
                       lay-verify="required"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="titile" name="titile" class="form-control input-title-700" lay-verify="required"
                       placeholder="请输入标题" value="${(entity.titile)!'--'}"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="brief" name="brief" class="form-control input-title-700" placeholder="请输入摘要"
                       value="${(entity.brief)!'--'}" lay-verify="brief"/>
            </div>
        </div>
        <div class="form-group">
                ...
                <select name="actionType" class="form-control select2 input-select-200" lay-verify="required"
                        ...
                        <@dictTag method="getDictListByType" type="action_type" >
                            <#list getDictListByType as m>
                                <option value="${(m.value)!}" ${(m.value==(entity.actionType?c))?string('selected','')}>${(m.label)!}</option>
                            </#list>
                        </@dictTag>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="actionPage2" name="actionPage2" class="form-control input-title-700"
                       placeholder="请输入动作目标地址/跳转页面(ios)" value="${(entity.actionPage2)!'--'}"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="appDownloadUrl1" name="appDownloadUrl1" class="form-control input-title-700"
                       placeholder="第三方app下载地址(android)" value="${(entity.appDownloadUrl1)!'--'}"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="appDownloadUrl2" name="appDownloadUrl2" class="form-control input-title-700"
                       placeholder="第三方app下载地址(ios)" value="${(entity.appDownloadUrl2)!'--'}"/>
            </div>
        </div>
        <div class="form-group">
            <input type="hidden" id="icon" name="icon" value="${(entity.icon)!''}" class="form-control"/>
            ...
            <div class="col-sm-10">
                <ul class="uiisar icon_url">
                    ...
                    <#if entity.icon ?? && entity.icon!="" >
                        <li>
                            <span class="layui-icon  layui-icon-close" name="icon"
                                  test="${(entity.icon)!''}">&#x1006;</span>
        ...
        <div class="form-group">
            <input type="hidden" id="qrcode" name="qrcode" value="${(entity.qrcode)!''}" class="form-control"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <ul class="uiisar qrcode_url">
                    ...
                    <#if entity.icon ?? && entity.icon!="" >
                        <li>
                            <span class="layui-icon  layui-icon-close" name="qrcode"
                                  test="${(entity.qrcode)!''}">&#x1006;</span>
                            <img src="<@commonTags method="tagHtpImgURL" type="1" value="1">${(tagHtpImgURL)!}</@commonTags>${(entity.qrcode)!''}">
                        </li>
                    </#if>
                    </#if>
                </ul>
            ...
            <div class="col-sm-10">
                <select name="qrcodeType" class="form-control select2 input-select-200" lay-ignore>
                        <@dictTag method="getDictListByType" type="qrcode_type" >
                            <#list getDictListByType as m>
                                <#if (entity.qrcodeType)??>
                                <option value="${(m.value)!}" ${(m.value==(entity.qrcodeType?c))?string('selected','')}>${(m.label)!}</option>
                                <#else >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                    <textarea name="webContent" cols="100" rows="100"
                              style="height:100px;">${(entity.webContent)}</textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                         <textarea name="explain" cols="100" rows="100"
                                   style="height:100px;">${(entity.explain)!}</textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" id="sortIndex" name="sortIndex" lay-verify="required"
                       class="form-control input-select-200" placeholder="请输入排序" value="${(entity.sortIndex)}"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <label>
                    <input name="hot" type="radio" class="minimal"  ${(entity.hot ==1)?string('checked','')} value="1"
                           lay-ignore> 是
                </label>
                <label>
                    <input name="hot" type="radio" class="minimal"  ${(entity.hot ==0)?string('checked','')} value="0"
                           lay-ignore> 否
                </label>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <label>
                    <input name="recommend" type="radio" class="minimal" ${(entity.recommend ==1)?string('checked','')}
                           value="1" lay-ignore> 是
                </label>
                <label>
                    <input name="recommend" type="radio" class="minimal"
                           value="0"  ${(entity.recommend ==0)?string('checked','')} lay-ignore> 否
                </label>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <button type="submit" class="btn btn-success" lay-submit lay-filter="submit"><i class="fa fa-save"></i>提
                    交
                </button>
            </div>
        </div>
