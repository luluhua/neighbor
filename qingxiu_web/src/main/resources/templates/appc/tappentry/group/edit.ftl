...
<@body>
    <form class="form-horizontal layui-form layui-form-pane" method="post" action="/appc/tAppEntry/doEditGroup">
        ...
        <div class="box-body">
                        ...
                        <@dictTag method="getDictListByType" type="app_entry_module_type" >
                            <#list getDictListByType as m>
                                <option value="${(m.value)!}"
                                        <#if "${(m.value)!}"=="${(entity.moduleId)!}">selected</#if>>${(m.label)!}</option>
                            </#list>
                        </@dictTag>
                    </select>
                </div>
            ...
            <div class="form-group">
                <label for="titile" class="col-sm-3 control-label">应用名称<span class="xing_red"> *</span></label>
                <div class="col-sm-5">
                    <input type="text" id="titile" name="titile" class="form-control input-select-200"
                           placeholder="请输入标题" value="${(entity.titile)!'--'}" lay-verify="required"/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="number" id="sortIndex" name="sortIndex" class="form-control input-select-200"
                           placeholder="请输入排序" value="${(entity.sortIndex)}" lay-verify="required|number"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <label>
                        <input name="isEnabled" type="radio" class="minimal" checked
