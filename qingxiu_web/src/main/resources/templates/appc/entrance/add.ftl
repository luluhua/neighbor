...
<form class="form-horizontal layui-form layui-form-pane" method="post" action="/appc/tProjectEntrance/doAdd">
    <div class="box-body">
                ...
                <select name="themeId" class="form-control select2" lay-ignore style="width: 100%;"
                    ...
                    <option>--请选择主题--</option>
                        <#list themeList as theme>
                            <option value="${(theme.id)!}">${(theme.themeTitle)!}</option>
                        </#list>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="entranceName" name="entranceName" class="form-control" placeholder="请输入口名称"
                       lay-verify="required"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="hidden"  id="entranceIcon" name="entranceIcon">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="entranceUrl" name="entranceUrl" class="form-control" placeholder="请输入口跳转地址"
                       lay-verify="required"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" id="sortIndex" name="sortIndex" class="form-control" placeholder="请输入排序（越大越靠前）"
                       lay-verify="required"/>
            </div>
        </div>
