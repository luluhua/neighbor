...
<form class="form-horizontal layui-form layui-form-pane" method="post"
      <#if (entity.id)??>action="/dj/partymember/doEdit"<#else>action="/dj/partymember/doAdd"</#if>>
    <div class="box-body">
        <input type="hidden" name="id" value="${(entity.id)!}"/>
        <div class="form-group">
            <label for="code" class="col-sm-3 control-label">姓名<span class="xing_red"> *</span></label>
            <div class="col-sm-9">
                <input type="text" name="name" value="${(entity.name)!}" class="form-control input-title-500"
                       placeholder="请输入姓名" lay-verify="required"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="code" class="col-sm-3 control-label">出生日期<span class="xing_red"> *</span></label>
            <div class="col-sm-9">
                <input type="text" class="form-control  input-select-200 partymember_datetime" id="birthday"
                       name="birthday"
                       value="${(entity.birthday)!}"
                       placeholder="选择出生日期" lay-verify="required">
            </div>
        </div>
        <div class="form-group">
            <label for="code" class="col-sm-3 control-label">入党日期<span class="xing_red"> *</span></label>
            <div class="col-sm-9">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <select name="partyBranchOrg" class="form-control select2 input-select-200" style="width: 500px" lay-ignore>
                <#list orgList as org>
        ...
        <div class="form-group">
            <label for="code" class="col-sm-3 control-label">排序<span class="xing_red"> *</span></label>
            <div class="col-sm-9">
