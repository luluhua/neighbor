...
<@body>
    <form class="form-horizontal layui-form layui-form-pane" method="post" action="/system/setting/doEdit">
        ...
        <div class="box-body">
                    ...
                    <select name="sysSettingGroup" class="form-control select2" lay-ignore style="width: 100%;"
                        ...
                        <@dictTag method="getDictListByType" type="setting_group" >
                            <#list getDictListByType as m>
                                <option value="${(m.value)!}" <#if "${(m.value)!}"=="${(code)!}">selected</#if>
                                "> ${(m.code)!}-${(m.label)!}</option>
                            </#list>
                        </@dictTag>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="sysKey" name="sysKey" class="form-control" placeholder="请输入系统设置key"
                           lay-verify="required" value="${(setting.sysKey)!''}">
                    <p class="help-block"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="sysName" name="sysName" class="form-control" placeholder="请输入系统设置名称"
                           lay-verify="required" value="${(setting.sysName)!''}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="sysValue" name="sysValue" class="form-control" placeholder="请输入系统设置值"
                           lay-verify="required" value="${(setting.sysValue)!''}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="sort" name="sort" class="form-control" placeholder="请输入排序"
                           lay-verify="required" value="${(setting.sort)!''}">
                </div>
            </div>
            <div class="form-group">
