...
<@body>
<form class="form-horizontal layui-form layui-form-pane" method="post" action="/system/role/doAdd">
  <div class="box-body">
    <div class="form-group">
      <label for="uname"  class="col-sm-2 control-label">角色名<span class="xing_red"> *</span></label>
       <div class="col-sm-10">
     		<input type="text" id="uname" name="name" class="form-control" placeholder="请输入角色名"  lay-verify="required">
    	 </div>
    </div>
      <div class="form-group">
          <label for="code"  class="col-sm-2 control-label">角色代码<span class="xing_red"> *</span></label>
          <div class="col-sm-10">
              <input type="text" id="code" name="code" class="form-control" placeholder="请输入角色代码"  lay-verify="required">
          </div>
      </div>
      <div class="form-group">
          <label for="sortIndex"  class="col-sm-2 control-label">排序<span class="xing_red"> *</span></label>
          <div class="col-sm-10">
              <input type="text" id="sortIndex" name="sortIndex" class="form-control" placeholder="请输入排序数字(数字越大越靠前)"  lay-verify="required">
          </div>
      </div>
    <div class="form-group">
    ...
    <div class="col-sm-10">
       <label>
           <input name="roleState" type="radio" class="minimal" checked value="1" lay-ignore> 启用
          </label>
       <label>
           <input name="roleState" type="radio" class="minimal"  value="-1" lay-ignore> 禁用
          </label>
       </div>
       </div>
       <div class="form-group">
