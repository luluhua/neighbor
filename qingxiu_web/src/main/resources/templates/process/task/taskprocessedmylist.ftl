                            ...
                            <table class="table table-hover">
                                ...
                                <#list pageData.getRecords() as entity>
                                    <tr>
                                        ...
                                        <td>${(entity.actHiActinst.endTime?string('yyyy/MM/dd HH:mm:ss'))!}</td>
                                        <td>
                                            <a class="btn btn-primary btn-xs dialog" href="javascript:;"
                                               data-url="/process/historyRunActinst?procDefId=${(entity.actHiActinst.procDefId)!''}&procInstId=${(entity.actHiActinst.procInstId)!}"
