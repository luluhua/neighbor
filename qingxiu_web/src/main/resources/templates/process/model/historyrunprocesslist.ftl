                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <#list pageData.getRecords() as entity>
                                    <tr>
                                        <td>${(entity.id)!}</td>
                                        <td>${(entity.startTime?string('yyyy/MM/dd HH:mm:ss'))!}</td>
                                        <td>${(entity.endTime?string('yyyy/MM/dd HH:mm:ss'))!}</td>
                                        <td><#if entity.rev==2><span style="color: green">已完结</span><#else ><span style="color: red;">运行中</span></#if></td>
                                        <td>
                                            <a class="btn btn-primary btn-xs dialog" href="javascript:;"
                                               data-url="/process/historyRunActinst?procDefId=${(entity.procDefId)!''}&procInstId=${(entity.procInstId)!}"
