                        ...
                        <div class="info_com">
                            <table class="layui-table">
                                ...
                                <tr>
                                    ...
                                    <td>${(govProject.dtCreate?string('yyyy-MM-dd'))!'--'}</td>
                                </tr>
                        ...
                        <div class="info_com">
                            <table class="layui-table">
                                ...
                                <tr>
                                    ...
                                    <td><@commonTags method="getDecrypt3DEs" type="1" value="${(appUser.mobile)!}">
                                        ${(getDecrypt3DEs)!}</@commonTags></td>
                                </tr>
                                <tr>
                                    <td style="text-align: right; background: #ebf5ff">身份证号码</td>
                                    <td><@commonTags method="getDecrypt3DEs" type="1" value="${(appUser.idCard)!}">
                                        ${(getDecrypt3DEs)!}</@commonTags></td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="info_com">
                                <table class="layui-table">
                                    ...
                                    <tr>
                                        ...
                                        <td><#if audit.result==0>
                                            不通过 <#else >通过</#if></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right; background: #ebf5ff">审核时间</td>
                                        <td>${(audit.dtCreate?string('yyyy-MM-dd HH:mm:ss'))!'--'}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <#list materiaList as materiaList>
                                            <@commonTags method="getFileSuffix" type="1" value="${(materiaList.materialsUrl)!'--'}">
                                                <#if getFileSuffix==0>
                                                      <img data-preview-src="<@commonTags method="tagHtpImgURL" type="1" value="1">${(tagHtpImgURL)!}</@commonTags>${(materiaList.materialsUrl)!'--'}"
                        ...
                        <div class="yueor">
                            ...
                            <div class="info_com">
                                <form class="form-horizontal" id="form-recird" method="post"
                                      action="/appc/tGovProjectAudit/approval">
                                    ...
                                    <table class="layui-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="mui-input-row mui-radio">
                                                    <label>通过</label>
                                                    <input name="result" type="radio" value="1" checked>
                                                </div>
                                                <div class="mui-input-row mui-radio">
                                                    <label>不通过</label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="orgId" id="orgId" class="mui-btn mui-btn-block">
