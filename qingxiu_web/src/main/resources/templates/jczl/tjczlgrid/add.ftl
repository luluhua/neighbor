...
<@body>
<form class="form-horizontal layui-form layui-form-pane" method="post" action="/jczl/tJczlGrid/doAdd"
      onsubmit="return doSaveToEdit()">
    <div class="box-body">

        <div class="form-group">
            <label for="gName" class="col-sm-2 control-label">网格名称</label>
            <div class="col-sm-10">
                <input type="text" id="gName" name="gName" class="form-control input-select-200" placeholder="请输入网格名称"
                       lay-verify="required"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" id="gCode" name="gCode" class="form-control input-select-200" placeholder="请输入网格编号"
                       lay-verify="required"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="gAddress" name="gAddress" class="form-control input-title-500"
                       placeholder="请输入网格地址"
                       lay-verify="required"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="textar-remark" id="gRemark" name="gRemark" placeholder="请输入备注"></textarea>
            <#--<input type="text" id="gRemark" name="gRemark" class="form-control" placeholder="请输入备注"/>-->
            </div>
        </div>
            ...
            <div class="col-sm-10">
                   <@dictTag method="getDictListByType" type="is_enabled" >
                       <#list getDictListByType as m>
                         <label>
                             <input name="gStatus" type="radio" class="minimal" checked value="${(m.value)!}"
                                    lay-ignore> ${(m.label)!}
                         </label>
                       </#list>
                   </@dictTag>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" id="gManagePerson" name="gManagePerson" class="form-control input-select-200"
                       placeholder="请输入网格管理人" lay-verify="required"/>
            </div>
        </div>
        <div class="form-group">
            <label for="gStatus" class="col-sm-2 control-label">网格坐标配置</label>
            <input id="AreaPoints" name="gCoordinate" type="hidden" value=""/>
