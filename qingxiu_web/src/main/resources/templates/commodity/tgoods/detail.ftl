...
<div class="box-body">
                    ...
                    <label for="tagId" class="col-sm-2 control-label">标签id</label>
                    <div class="col-sm-10">
                        <input type="text" disabled id="tagId" name="tagId" value="${(entity.tagId)!}" class="form-control"  />
                    </div>
                </div>
                                                                                                            <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" disabled id="describe" name="describe" value="${(entity.describe)!}" class="form-control"  />
                    </div>
                </div>
                                                                                                                        <div class="form-group">
                    <label for="quantity" class="col-sm-2 control-label">数量</label>
                    <div class="col-sm-10">
                        <input type="number" disabled id="quantity" name="quantity" value="${(entity.quantity)!}" class="form-control"  />
                    </div>
                </div>
                                                                                                <div class="form-group">
                    <label for="specification" class="col-sm-2 control-label">规格</label>
                    <div class="col-sm-10">
                        <input type="text" disabled id="specification" name="specification" value="${(entity.specification)!}" class="form-control"  />
                    </div>
                </div>
                                                                                                            <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" disabled id="priceType" name="priceType" value="${(entity.priceType)!}" class="form-control"  />
                    </div>
                </div>
                                                                                                            <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" disabled id="navigationCode" name="navigationCode" value="${(entity.navigationCode)!}" class="form-control"  />
                    </div>
                </div>
                                                                        </div>
</@body>
