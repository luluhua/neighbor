...
public class RedisUtil {
     ...
     * @param value
     */
    public static void setCustomPackageKeyValue(String customPackage,String key, String value) {
        jedisUtil.new Strings().setEx(customPackage + ":" + key, expire, value);
    }
    /**
     * 添加 reids  缓存
     *
     ...
     * @param
     */
    public static void delCustomPackageKey(String packageStr,String key) {
        jedisUtil.new Keys().del( packageStr+ ":" + key);
    }
    /**
     * 删除指定包下key
     *
