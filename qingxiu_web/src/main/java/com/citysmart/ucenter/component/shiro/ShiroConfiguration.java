...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setUnauthorizedUrl("/loginApp");
        //首页
        ...
        filterChainDefinitionMap.put("/jcjd/**","anon");
        filterChainDefinitionMap.put("/download","anon");
        filterChainDefinitionMap.put("/logout", "logout");
        filterChainDefinitionMap.put("/logOutApp", "app");
        filterChainDefinitionMap.put("/indexApp", "app");
        filterChainDefinitionMap.put("/indexApp/", "app");
        filterChainDefinitionMap.put("/indexApp/*", "app");
        filterChainDefinitionMap.put("/images/**", "anon");
        filterChainDefinitionMap.put("/plugins/**", "anon");
        filterChainDefinitionMap.put("/login", "anon");
        filterChainDefinitionMap.put("/login/forgetPassword", "anon");
        filterChainDefinitionMap.put("/login/sendVerifCode", "anon");
        filterChainDefinitionMap.put("/login/*", "anon");
        filterChainDefinitionMap.put("/loginApp", "anon");
        filterChainDefinitionMap.put("/m/**", "anon");
        filterChainDefinitionMap.put("/_m/**", "anon");
