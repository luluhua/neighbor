...
public class PatternUtil {
    ...
    public final static  Integer CODE_0=-1;
    public final static  Integer CODE_1=1;
    public final static  Integer CODE_2=2;
    public final static  Integer CODE_3=3;
    /**
     * 验证带区号的
     */
    private static final Pattern MOBILE_QH = Pattern.compile("^[0][0-9]{2,3}-?[0-9]{5,10}$");
    /**
     * 验证不带区号
     */
    private static final Pattern MOBILE_NOT_QH = Pattern.compile("^[1-9]{1}[0-9]{5,8}$");

    public static Integer verfiyUserName(String userName) {
        if (isMobile(userName)) {
            ...
            //身份證
            return  CODE_2;
        } else if (isLicense15(userName)||isLicense18(userName)) {
            //統一信用代碼
            return  CODE_3;
        }
        return CODE_0;
    ...
    public static boolean isPhone(String phone) {
        ...
        boolean b = false;
        if (phone.length() > 9) {
            m = MOBILE_QH.matcher(phone);
            b = m.matches();
        } else {
            m = MOBILE_NOT_QH.matcher(phone);
            b = m.matches();
        }
        return b;
    }
