 ...
 -->
        ...
        <div class="mui-content mui-scroll-wrapper">
            <div class="mui-scroll" id="boodylie">
                <div class="box">
                    <form class="form-horizontal" id="form-recird" action="${ctx}/qingxiuh5/qcc/doGetAnnualReportSummary"
                          method="post"  onsubmit="return verification()">
                        <div class="search_info">
                            <span >关键字 <font color="red">*</font></span>
                            <input name="keyNo"  type="text" placeholder="输入公司名称（全称）查询" style="margin-top: 10px"/>
