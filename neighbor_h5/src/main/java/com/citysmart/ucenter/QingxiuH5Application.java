...
public class QingxiuH5Application extends SpringBootServletInitializer {

    @Override
    protected SpringApplicationBuilder configure(SpringApplicationBuilder builder) {
        return builder.sources(QingxiuH5Application.class);
    }

    public static void main(String[] args) {
        SpringApplication.run(QingxiuH5Application.class, args);
    }
}
