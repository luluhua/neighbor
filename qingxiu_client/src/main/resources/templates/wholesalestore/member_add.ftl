...
<script type="text/javascript" src="js/fanhuidibu.js"></script>  
...
<script type="text/javascript" src="js/member_add.js"></script>
...
<div class="member_cent">
	<div class="left">
		...
		<ul class="menu_ul">
			...
			<li><a href="member_add.html" class="menu_a">收货地址</a></li>
	...
	<div class="right">
		<div class="common_border">
			...
			<h1 class="xz_add">编辑收货地址</h1>

			<ol class="add_ol">
				<li>
				    <input type="text" class="text" style="display: none" value="" id="addressID"/>
					<p>收货人 ：</p>
					<input type="text" value="" id="consigneeName">
				</li>

				<li>
					<p>收货地址 ：</p>
					<div class="common_fl info add_info">
						...
						<textarea placeholder="输入详细地址" id="detailedAddress"></textarea>
					</div>
			...
			<div class="add_div">
				...
				<h6>
					...
					<p>联系电话</p>
					<p>邮政编码</p>
					<p class="pB pB_hidden">操作</p>
				</h6>
				
                <!-- 
			    <h6 class="h6">
					<p>小赖同学</p>
					<p class="pA">广西南宁市青秀区合作路区合作路昌泰大厦905</p>
					<p>1507898888</p>
					<p class="pC">535000</p>
					<p class="pB">
						<span class="span">默认地址</span>
						<span>修改</span>
						<span>删除</span>
					</p>
				</h6>
				...
				<h6 class="h6">
					<p>小赖同学</p>
					<p class="pA">广西  南宁市  青秀区合作路昌泰大厦905</p>
					<p>1507898888</p>
					<p class="pC">535000</p>
					<p class="pB">
						<span class="span">设为默认</span>
						<span>修改</span>
						<span>删除</span>
					</p>
				</h6>
                 -->
				<h6 class="h6"  id="ListReceiving">				 
				<p>小赖同学</p>
					<p class="pA">广西  南宁市  青秀区合作路昌泰大厦905</p>
					<p>1507898888</p>
					<p class="pC">535000</p>
