...
<script type="text/javascript" src="js/member_Goid.js"></script>
...
<div class="member_cent">
	<div class="left">
		...
		<ul class="menu_ul">
			...
			<li><a href="member_Goid.html" class="menu_a">我的金币</a></li>
	...
	<div class="right">
		...
		<dl>
			<dd class="dd">
				<p>可用金币：</p>
				<b id="gold">0</b>
				<span>温馨提示：您所获得的金币，可用于兑换商品。</span>
			</dd>
		...
		<div class="common_border">
			...
			<!--没有产品时的页面-->
			<div class="order_none coupons massage_none">
				<p>您暂时还没有可兑换的商品  !</p>
			</div>
           <!-- 
			<div class="orderA_div">
				...
				<ul class="orderA_ul">
					...
					<li class="date_liB">1</li>

					<li class="date_liC">
						<a href="Make_sure_order.html" class="date_a">兑换</a>
