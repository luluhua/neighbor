...
<div class="member_cent">
	<div class="left">
		...
		<ul class="menu_ul">
			...
			<li><a href="member_collection.html" class="menu_a">我的收藏</a></li>
	...
	<div class="right">
		<div class="common_border">
			<h3 id="h3">
				<p>我的收藏</p>
				<p class="p">共 <b id="collectProduct">0</b> 件</p>
			</h3>

			<!--没有产品时的页面-->
			<div class="order_none">
				<p>您没有收藏的产品，<a href="index.html">去逛逛　！＞＞</a></p>
			</div>
			...
			<ol id="collections" class="collection">
				...
				<li>
					<div class="coll_div">
						...
						<h3><a href="product_details.html">自行车包自行车自行车自行车自行车行车骑</a></h3>
						<h4>CycleDesign-CDBG0057</h4>
						<p>
							<span>￥310</span>
							<a href="">加入购物车</a>
						</p>
			...
			<!--翻页-->
			<div class="page coll_page" style="display: none">
