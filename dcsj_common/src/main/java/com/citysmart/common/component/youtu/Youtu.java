package com.citysmart.common.component.youtu;


import com.alibaba.fastjson.JSONException;
import com.alibaba.fastjson.JSONObject;
import com.citysmart.common.component.youtu.sign.Base64Util;
import com.citysmart.common.component.youtu.sign.YoutuSign;
...
public class Youtu {
	 ...
	 */
	public JSONObject TableocrOcrUrl(String image_url) throws IOException,
																JSONException, KeyManagementException, NoSuchAlgorithmException {
		JSONObject data = new JSONObject();

		data.put("url", image_url);

		JSONObject response = m_not_use_https ? SendHttpRequest(data, "ocrapi/tableocr") : SendHttpsRequest(data, "ocrapi/bizlicenseocr");
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	public JSONObject StructureocrUrl(String image_url) throws IOException,
															  JSONException, KeyManagementException, NoSuchAlgorithmException {
		JSONObject data = new JSONObject();

		data.put("url", image_url);

		JSONObject response = m_not_use_https ? SendHttpRequest(data, "ocrapi/structureocr") : SendHttpsRequest(data, "ocrapi/bizlicenseocr");
