...
public class CookieUtils {
    ...
    public static void showCookie() {
        ...
        for (int i = 0; i < (c == null ? 0 : c.length); i++) {
            logger.info("一条cookie____  name: " + c[i].getName() + "  || value: " + c[i].getValue());
        }
    }
    ...
    public static void addCookie(String name, Object object) {
        try {
            ...
            if(object instanceof  String){
                v=URLEncoder.encode(object.toString(), "UTF-8");
            }else{
                v=URLEncoder.encode(new Gson().toJson(object), "UTF-8");
            }
            ...
            logger.info(" -------添加cookie 失败！--------" + e.getMessage());
        }
    }
    public static void addCookieInSession(String name, Object object) {
        try {
            String v =null;
            if(object instanceof  String){
                v=URLEncoder.encode(object.toString(), "UTF-8");
            ...
            logger.info(" -------添加addCookieInSession 失败！--------" + e.getMessage());
        }
    }
    ...
    public static <T> T getCookie(String name, Class<T> clazz) {
        try {
            ...
            logger.info("------获取 clazz Cookie 失败----- " + e.getMessage());
        }
        return null;
    }
    ...
    public static String getCookie(String name) {
        try {
            ...
            logger.info(" --------获取String cookie 失败--------   " + e.getMessage());
        }
        return null;
    }
